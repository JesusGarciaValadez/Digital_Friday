...
define('SITE_URL', 'http://www.cmv.com.mx/digitalfriday/'); // Ej. http://localhost/lukajobs/registro_de_invitados/templates/
...
define('CHUNKS_PATH', CODE_PATH .'templates' . DIRECTORY_SEPARATOR );
